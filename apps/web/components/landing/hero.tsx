  ...
  return (
    <section className="relative border-b border-[#242421] bg-[#f4cf4b]">
      ...
      >
        ...
        <h1 className="max-w-5xl text-[clamp(4.7rem,6vw,5.8rem)] font-black leading-[0.86] tracking-[-0.05em]">
          You bring the background.
          <br />
        ...
        <div className="mt-12 grid max-w-4xl gap-8 border-t border-[#756427] pt-6 md:grid-cols-[1fr_1.2fr]">
          ...
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                href="/signup"
                className="inline-flex items-center gap-2 rounded-full bg-[#20201e] px-5 py-3 text-sm font-semibold text-[#fffdf7]"
              >
