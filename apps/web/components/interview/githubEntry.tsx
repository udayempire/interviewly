    ...
    return (
        <div className="border border-border p-5 rounded-lg bg-card flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3">
                <div className="shrink-0 h-9 w-9 rounded-lg bg-[#f0fdf4] dark:bg-emerald-950/30 flex items-center justify-center">
            ...
            {/* GitHub URL input */}
            <div className="flex items-center gap-2.5 border border-border rounded-lg px-3 py-2.5 bg-muted focus-within:ring-1 focus-within:ring-blue-400 focus-within:border-blue-400 transition-all">
