...
export const Preparation = () => {
    return (
        <div className="flex h-screen w-full items-center justify-center bg-linear-to-b from-background to-blue-50/40 dark:to-blue-950/10 p-6">
            <div className="flex flex-col items-center text-center max-w-md w-full">
                ...
                <p className="text-[15px] text-muted-foreground leading-relaxed mb-10 max-w-sm">
                ...
                <div className="flex items-center gap-3 mb-10 w-full justify-center">
                    ...
                    <div className="flex flex-col items-center gap-2 w-28">
                        <div className="relative h-14 w-14 rounded-xl bg-card border border-border shadow-sm flex items-center justify-center">
                            ...
                            <span className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full bg-green-500 border-2 border-background flex items-center justify-center">
                        ...
                        <span className="text-[12px] font-medium text-muted-foreground">GitHub Projects</span>
                    ...
                    <div className="flex flex-col items-center gap-2 w-28">
                        ...
                        <span className="text-[12px] font-medium text-muted-foreground">Resume</span>
                        <span className="text-[11px] font-semibold text-green-500">Analyzed</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2 w-28">
                        <div className="relative h-14 w-14 rounded-xl bg-card border border-border shadow-sm flex items-center justify-center">
                            ...
                            <span className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full bg-purple-100 dark:bg-purple-900/40 border-2 border-background flex items-center justify-center">
                                <Loader2 className="h-2.5 w-2.5 text-purple-500 animate-spin" />
                            </span>
                        </div>
                        <span className="text-[12px] font-medium text-muted-foreground">Role Description</span>
                        <span className="text-[11px] font-semibold text-purple-500">Analyzing...</span>
                    </div>
                </div>

                {/* Bottom connecting pill */}
                <div className="flex items-center gap-3 bg-card border border-border rounded-2xl px-5 py-3.5 shadow-sm w-full max-w-xs">
                    <Loader2 className="h-5 w-5 text-blue-500 animate-spin shrink-0" />
                    <div className="text-left">
                        <p className="text-[13px] font-semibold text-foreground">Connecting to AI Interview Room...</p>
