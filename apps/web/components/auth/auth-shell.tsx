...
export function AuthShell({
  ...
  const panel = (
    <aside className="relative hidden h-[100dvh] overflow-hidden border-[#272724] bg-[#f4cf4b] text-[#20201e] lg:flex lg:flex-col lg:justify-between lg:border-r lg:p-8 xl:p-12">
      <div className="landing-grid pointer-events-none absolute inset-0 opacity-[0.14]" />
      <Link
        href="/"
        className="relative flex w-fit items-center gap-2.5 font-bold tracking-[-0.06em] text-[#20201e]"
      >
        <span className="grid h-8 w-8 place-items-center rounded-full border-2 border-[#20201e] text-[13px] leading-none text-[#20201e]">
          i.
        </span>
        <span className="text-xl text-[#20201e]">interviewlyy</span>
      </Link>
      ...
      <div className="relative my-auto max-w-md py-10">
        ...
        <h2 className="text-4xl font-black leading-[0.9] tracking-[-0.048em] text-[#20201e] xl:text-5xl">
      ...
      <div className="relative border-t border-[#8c792d] pt-5">
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm font-semibold tracking-[-0.025em] text-[#20201e]">
  ...
  const form = (
    <section className="relative flex h-[100dvh] items-center overflow-hidden bg-[#e9e7df] px-5 py-5 text-[#20201e] sm:px-10 lg:px-16 xl:px-24">
      ...
      <Link
        href="/"
        className="absolute left-5 top-6 z-10 flex items-center gap-2.5 font-bold tracking-[-0.06em] text-[#20201e] lg:hidden"
      >
        <span className="grid h-8 w-8 place-items-center rounded-full border-2 border-[#20201e] text-[13px] leading-none text-[#20201e]">
          i.
        </span>
      ...
      <div className="relative mx-auto w-full max-w-md pt-10 lg:pt-0">
        ...
        <h1 className="max-w-sm text-3xl font-black leading-[0.92] tracking-[-0.065em] text-[#20201e] sm:text-4xl">
          {title}
        </h1>
  ...
  return (
    <main className="grid h-[100dvh] overflow-hidden bg-[#e9e7df] text-[#20201e] lg:grid-cols-2">
